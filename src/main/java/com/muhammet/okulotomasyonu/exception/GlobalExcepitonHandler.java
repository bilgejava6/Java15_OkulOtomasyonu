...
public class GlobalExcepitonHandler {
    ...
    @ExceptionHandler(OkulOtomasyonuException.class)// istisnayı yakalayan kısım
    @ResponseBody
    public ResponseEntity<ErrorMessage> okulOtomasyonuExceptionHandler(OkulOtomasyonuException exception){
